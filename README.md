...
The dataset includes the required supermarket information for customers, categories, products, orders, and order items.
...
Sunrise Supermarket needs a database system to manage customers, products, product categories, and customer orders.
